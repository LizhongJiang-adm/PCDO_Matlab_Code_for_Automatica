% = a=======================================================================
% Main script for solving the VDPO Problem with the Polynomial Method
% =========================================================================
% Description:
% This script sets up the VDPO problem, configures the Polynomial
...
clc;
close all;
addpath("ProblemFormulation_Poly_VDPO") 


%% --- 3. Setup Problem and Options ---
fprintf('Step 1: Defining the VDPO problem for the Polynomial Method...\n');
problem = define_VDPO_problem_Poly();
...
switch ExecutionMode
    ...
    case 'Benchmark'
        ...
        fprintf('---------------------------------------------------\n');
        fprintf('Benchmark Result for VDPO (Polynomial Method):\n');
...
fprintf('\n--- VDPO (Polynomial Method) Workflow Complete ---\n');

if strcmp(ExecutionMode,'Benchmark') 
    save("Result_VDPO_Poly");
end