% =========================================================================
% Main script for solving the VDPO Problem with the Interval Method
% =========================================================================
% Description:
% This script sets up the VDPO problem, configures the Interval Method solver,
...
addpath("ProblemFormulation_Intvl_VDPO");


%% --- 3. Setup Problem and Options ---
fprintf('Step 1: Defining the VDPO problem for the Interval Method...\n');
problem = define_VDPO_problem_Interval();
...
switch ExecutionMode
    case 'Solve'
        ...
        if solution.exitFlag > 0
            % We need a plotting function for the Interval Method results.
            % Let's assume a function 'plot_results_Interval' exists.
            % We can adapt one of our previous plotting functions for this.
    ...
    case 'Benchmark'
        ...
        fprintf('---------------------------------------------------\n');
        fprintf('Benchmark Result for VDPO (Interval Method):\n');
...
fprintf('\n--- VDPO (Interval Method) Workflow Complete ---\n');

if strcmp(ExecutionMode,'Benchmark') 
    save("Result_VDPO_Interval");
end