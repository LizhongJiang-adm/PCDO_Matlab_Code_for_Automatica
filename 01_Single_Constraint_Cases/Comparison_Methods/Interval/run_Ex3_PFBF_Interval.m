% =========================================================================
% Main script for solving the PFBF Problem with the Interval Method
% =========================================================================
% Description:
% This script sets up the PFBF problem, configures the Interval Method solver,
...
% Add path to the folder containing the PFBF problem-specific functions
addpath("ProblemFormulation_Intvl_PFBF");


%% --- 3. Setup Problem and Options ---
fprintf('Step 1: Defining the PFBF problem for the Interval Method...\n');
problem = define_PFBF_problem_Interval();
...
switch ExecutionMode
    ...
    case 'Benchmark'
        ...
        fprintf('---------------------------------------------------\n');
        fprintf('Benchmark Result for PFBF (Interval Method):\n');
...
fprintf('\n--- PFBF (Interval Method) Workflow Complete ---\n');


if strcmp(ExecutionMode,'Benchmark') 
    save("Result_PFBF_Interval");
end