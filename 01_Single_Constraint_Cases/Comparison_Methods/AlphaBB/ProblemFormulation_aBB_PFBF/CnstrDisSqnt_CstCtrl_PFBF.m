function [Cieq, Ceq, G_Cieq, G_Ceq] = CnstrDisSqnt_CstCtrl_PFBF(u,CvpGrd,x0,T_Dis)
...
for i = 1:NTrGd
	...
	% 对系统进行积分
	[t, x] = ode45(@(t,x)OdeSnstvSqnt_CstCtrl_PFBF(t,x,CurDec,CurIdx,N,[C_t0,C_tf]),...
