% =========================================================================
% Main script for solving the VDPO Problem with the Direct Discretization Method
% =========================================================================
% Description:
% This script sets up the VDPO problem, configures the direct discretization
...
clc;
close all;
addpath("ProblemFormulation_Dis_VDPO");


%% --- 3. Setup Problem and Options ---
fprintf('Step 1: Defining the VDPO problem for the Direct Discretization Method...\n');
problem = define_VDPO_problem_Dis();
...
switch ExecutionMode
    case 'Solve'
        ...
        if solution.exitFlag > 0
            % Reuse a standard plotting function to show the final path constraint profile.
    ...
    case 'Benchmark'
        ...
        fprintf('---------------------------------------------------\n');
        fprintf('Benchmark Result for VDPO (Discretization Method):\n');
...
fprintf('\n--- VDPO (Discretization Method) Workflow Complete ---\n');


if strcmp(ExecutionMode,'Benchmark') 
    save("Result_VDPO_Dis");
end