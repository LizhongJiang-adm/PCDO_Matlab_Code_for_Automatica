% =========================================================================
% Main script for solving the JCB Problem with the Direct Discretization Method
% =========================================================================
% Description:
% This script sets up the JCB problem, configures the direct discretization
...
clc;
close all;
addpath("ProblemFormulation_Dis_JCB");


%% --- 3. Setup Problem and Options ---
fprintf('Step 1: Defining the JCB problem for the Direct Discretization Method...\n');
problem = define_JCB_problem_Dis();
...
switch ExecutionMode
    ...
    case 'Benchmark'
        ...
        fprintf('---------------------------------------------------\n');
        fprintf('Benchmark Result for JCB (Discretization Method):\n');
...
fprintf('\n--- JCB (Discretization Method) Workflow Complete ---\n');
