...
% =========================================================================
% Description:
% This script sets up the JCB problem, configures the solver, runs the
...
fprintf('Step 1: Defining the JCB optimal control problem...\n');
...
switch ExecutionMode
    case 'Solve'
        ...
        if solution.exitFlag > 0
            ...
            saveResult = false;
            if saveResult
                exportgraphics(gcf, "Path_Constraint_Profile_JCB.pdf", 'Resolution', 600, 'ContentType', 'vector');
            end
        else
    ...
    case 'Benchmark'
        ...
        fprintf('---------------------------------------------------\n');
        fprintf('Benchmark Result for JCB Problem:\n');
