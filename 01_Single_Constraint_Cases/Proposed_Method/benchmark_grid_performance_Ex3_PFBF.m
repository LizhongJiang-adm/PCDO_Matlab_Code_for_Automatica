% =========================================================================
% benchmark_grid_performance_Ex3_PFBF
% =========================================================================
% Description:
...
problem_template = define_PFBF_problem();
...
saveResult = false;
if saveResult
    exportgraphics(gcf, "Benchmark_Grid_Ex3_PFBF.pdf", 'Resolution', 600, 'ContentType', 'vector');
end
%% --- 4. Save Workspace Data ---
% save('Benchmark_Grid_Results_Ex3_PFBF.mat', 'initial_interval_counts', 'cpu_times', 'iteration_counts');
