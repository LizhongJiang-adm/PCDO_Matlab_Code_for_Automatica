% =========================================================================
% Main script for solving the PFBF Optimal Control Problem
% =========================================================================
% Description:
% This script sets up the PFBF problem, configures the solver, runs the
...
switch ExecutionMode
    case 'Solve'
        ...
        if solution.exitFlag > 0
            ...
            saveResult = false;
            if saveResult
                exportgraphics(gcf, "Path_Constraint_Profile_PFBF.pdf", 'Resolution', 600, 'ContentType', 'vector');
            end
        else
    ...
    case 'Benchmark'
        ...
        fprintf('---------------------------------------------------\n');
        fprintf('Benchmark Result for PFBF Problem:\n');
