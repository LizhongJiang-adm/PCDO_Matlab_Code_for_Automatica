% =========================================================================
% benchmark_grid_performance_Ex2_JCB
% =========================================================================
% Description:
...
problem_template = define_JCB_problem();
...
saveResult = false;
if saveResult
    exportgraphics(gcf, "Benchmark_Grid_Ex2_JCB.pdf", 'Resolution', 600, 'ContentType', 'vector');
end

%% --- 4. Save Workspace Data ---
% save('Benchmark_Grid_Results_Ex2_JCB.mat', 'initial_interval_counts', 'cpu_times', 'iteration_counts');
